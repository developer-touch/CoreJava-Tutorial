...
public class Question05GetNameAllEmployeeWhoJoinedAfterGivenYear {
	public static void main(String[] args) {
		...
		/**
		 * 	5. Get the name of all employee who joined after year of 2015
		 */
		employeeList.stream().filter(e->e.getYearOfJoin()>2015).map(Employee::getName).forEach(name->System.out.println(name));
