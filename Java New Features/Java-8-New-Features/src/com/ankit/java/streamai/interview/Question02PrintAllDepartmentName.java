...
public class Question02PrintAllDepartmentName {
	public static void main(String[] args) {
		System.out.println("Question02PrintAllDepartmentName.main()::main started");
		 ...
		 */
		employeeList.stream().map(e->e.getDepartment()).distinct().forEach(name->System.out.println(name));
		System.out.println("Question02PrintAllDepartmentName.main()::main ended");
	}
}
