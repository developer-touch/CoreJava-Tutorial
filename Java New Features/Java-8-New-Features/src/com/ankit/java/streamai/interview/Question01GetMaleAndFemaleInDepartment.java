...
public class Question01GetMaleAndFemaleInDepartment {
	public static void main(String[] args) {
		System.out.println("Q01_GetNumOfMaleAndFemaleInDepartment.main()::main started");
		...
		/**
		 * 1. How many male and female employees are there in the department
		 */
		Map<String, Long> map1 = employeeList.stream()
				.collect(Collectors.groupingBy(Employee::getGender, Collectors.counting()));
		System.out.println(map1);
		System.out.println("Q01_GetNumOfMaleAndFemaleInDepartment.main()::main ended");
	}
}
