...
public class Question06CountNoOfEmployeeInEachDepartment {
	public static void main(String[] args) {
		...
		employeeList.add(new Employee(7, "Ramesh", 35, "Male", 2016, 27000.0, "Finance"));
		employeeList.add(new Employee(8, "Suresh", 32, "Male", 2018, 80000.0, "Development"));
		...
		employeeList.add(new Employee(12, "Nitin", 24, "Male", 2013, 28400.0, "Development"));
		...
		/**
		 * 	5. Count the number of employee in each department
		 */
