...
public class Question03AverageAgeOfMaleAndFemale {
	public static void main(String[] args) {
		System.out.println("Question03AverageAgeOfMaleAndFemale.main()::main started");
		...
		System.out.println("Question03AverageAgeOfMaleAndFemale.main()::main ended");
	}
}
